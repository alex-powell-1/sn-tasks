...
def export_retail_customer_csv(eh=error_handler):
    retail_query = """
...
def export_wholesale_customer_csv(eh=error_handler):
    retail_query = """
...
def export_customers_to_csv(eh=error_handler):
...
def set_contact_1(eh=error_handler):
...
def fix_first_and_last_sale_dates(dt, eh=error_handler):
